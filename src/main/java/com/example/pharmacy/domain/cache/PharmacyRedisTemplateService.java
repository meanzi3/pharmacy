package com.example.pharmacy.domain.cache;
...
public class PharmacyRedisTemplateService {
  ...
  private HashOperations<String, String, String> hashOperations; // hash key, sub key(약국 데이터의 pk값), value (약국 dto를 string 형태로 변경)
